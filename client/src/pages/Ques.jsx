...
const Ques = () => {
  return (
    <section
      className="h-auto w-auto mt-20 border-b py-12 border-gray-500"
    >
     
      <div className="flex flex-col px-20 justify-center text-center items-center ">
        <h2 className="text-black text-4xl font-bold mt-10">Frequently asked questions</h2>
        <h1 className=" mt-5 px-20 text-2xl  text-gray-500">
