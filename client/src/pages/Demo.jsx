...
const Demo = () => {
  return (
    <section className="h-auto w-auto flex flex-col lg:flex-row justify-center items-center border-b border-gray-500 relative">
      {/* Left div */}
      ...
      {/* Right div */}
      <div className="h-screen w-screen lg:w-1/2 px-4 lg:px-0 flex relative justify-center items-center  z-0">
        <div className=" bg-white w-2/3 lg:w-1/2 md:w-3/4 h-auto px-10 py-10 rounded-lg absolute lg:bottom-[200px] md:bottom-0 bottom-20 transform -translate-x-1/2 left-1/2">
          {/* Card content */}
          ...
          <div className="flex flex-col md:flex-row  w-1/2 bg-gray-200 rounded-sm p-3 mb-4">
          
          </div>
          <Button className="mx-auto mt-4 ml-20 md:ml-40 lg:ml-[70px]">Get Started Now</Button>
        </div>
