...
const Demo = () => {
  return (
    <section className="flex flex-col lg:flex-row justify-center items-center border-b border-gray-500 relative">
      {/* Left div */}
      <div className="w-full lg:w-1/2 px-4 lg:px-10 flex justify-center items-center z-10">
      ...
      {/* Right div */}
      <div className="w-full lg:w-1/2 px-4 lg:px-0 flex relative justify-center items-center  z-0">
        <div className="bg-white w-2/3 lg:w-1/2 md:w-3/4 h-auto px-10 py-10 rounded-lg absolute bottom-10 transform -translate-x-1/2 left-1/2">
          {/* Card content */}
          <h2 className="text-2xl text-center font-bold mb-4">Check Us Out</h2>
          <div className="flex flex-col md:flex-row sm:mx-auto w-full bg-gray-200 rounded-sm p-3 mb-4">
          
          </div>
          <div className="flex flex-col md:flex-row sm:mx-auto w-1/2 bg-gray-200 rounded-sm p-3 mb-4">
          
          </div>
          <Button className="mx-auto mt-4 ml-20 md:ml-40">Get Started Now</Button>
        </div>
        <div className="bg-white rounded-lg overflow-hidden">
          <img src="/bg.png" alt="" className="w-full lg:w-[560px] lg:h-[560px]" />
        </div>
      </div>
    </section>
  );
