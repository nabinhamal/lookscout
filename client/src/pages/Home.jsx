...
const Home = () => {
  return (
    <section className="h-auto w-screen  bg-[#EAEBF0]">
      <div className="flex flex-col justify-center text-center items-center h-screen">
        ...
        <h1 className="md:text-5xl lg:text-6xl text-4xl lg:text-5xl text-black font-bold mt-4">
          Hype got you here.
        </h1>
        <h2 className="md:text-5xl lg:text-6xl text-4xl lg:text-5xl text-black font-bold">
